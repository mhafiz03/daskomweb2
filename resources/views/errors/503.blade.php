...
<body class="bg-[#0a480a] min-h-screen flex justify-center items-center relative">
    <div class="bg-[#0a480a] min-h-screen flex flex-col justify-center items-center text-center">
        ...
        <h4 class="text-gray-300 text-4xl font-extrabold">LMS Daskom is under maintenance</h4>
        <p class="text-gray-300 text-lg mt-2">We are currently performing scheduled maintenance. Please check back later.</p>
    </div>
</body>
</html>
