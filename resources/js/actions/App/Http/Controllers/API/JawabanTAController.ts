...
/**
* @see \App\Http\Controllers\API\JawabanTAController::showAsisten
* @see app/Http/Controllers/API/JawabanTAController.php:19
* @route '/api-v1/jawaban-ta/praktikan/{praktikan}/modul/{modul}'
*/
...
showAsisten.definition = {
    methods: ["get","head"],
    url: '/api-v1/jawaban-ta/praktikan/{praktikan}/modul/{modul}',
...
* @see app/Http/Controllers/API/JawabanTAController.php:66
...
* @see app/Http/Controllers/API/JawabanTAController.php:188
...
/**
* @see \App\Http\Controllers\API\JawabanTAController::score
* @see app/Http/Controllers/API/JawabanTAController.php:136
* @route '/api-v1/nilai-ta/{praktikanId}/{modulId}'
*/
...
score.definition = {
    methods: ["get","head"],
    url: '/api-v1/nilai-ta/{praktikanId}/{modulId}',
} satisfies RouteDefinition<["get","head"]>
...
const JawabanTAController = { showAsisten, store, show, score }
