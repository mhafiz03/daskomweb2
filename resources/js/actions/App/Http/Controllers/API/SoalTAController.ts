...
* @see app/Http/Controllers/API/SoalTAController.php:51
...
* @see app/Http/Controllers/API/SoalTAController.php:20
* @route '/api-v1/soal-ta/{idModul}'
*/
...
* @see app/Http/Controllers/API/SoalTAController.php:80
...
* @see app/Http/Controllers/API/SoalTAController.php:119
* @route '/api-v1/soal-ta/{idSoal}'
*/
