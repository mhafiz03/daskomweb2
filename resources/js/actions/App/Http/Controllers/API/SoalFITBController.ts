...
/**
* @see \App\Http\Controllers\API\SoalFITBController::show
* @see app/Http/Controllers/API/SoalFITBController.php:57
* @route '/api-v1/soal-fitb/{idModul}'
*/
...
/**
* @see \App\Http\Controllers\API\SoalFITBController::store
* @see app/Http/Controllers/API/SoalFITBController.php:22
* @route '/api-v1/soal-fitb/{idModul}'
*/
...
/**
* @see \App\Http\Controllers\API\SoalFITBController::update
* @see app/Http/Controllers/API/SoalFITBController.php:82
* @route '/api-v1/soal-fitb/{idSoal}'
*/
...
/**
* @see \App\Http\Controllers\API\SoalFITBController::destroy
* @see app/Http/Controllers/API/SoalFITBController.php:126
* @route '/api-v1/soal-fitb/{idSoal}'
*/
...
const SoalFITBController = { show, store, update, destroy }

export default SoalFITBController